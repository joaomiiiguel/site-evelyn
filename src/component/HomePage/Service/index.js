...
export default function Service() {
    return (
        <div className='flex flex-col items-center text-center bg-secondary bgPalestra'>
            ...
            <div className='flex flex-col justify-around items-center px-[10%] md:px-[15%] w-screen pt-10 md:items-end md:flex-row md:justify-around min-h-[80vh]'>
                <div className='flex flex-col w-5/6 justify-start space-y-8 md:space-y-20 md:h-[80vh] md:pt-14 md:w-1/2 md:pr-10'>
                ...
                <Image src={palestra1} width={400} alt="mulher falando no microfone" className='w-5/6 md:w-1/2' loading="lazy"/>
            </div>
