...
export default function Imersao() {
    return (
        <div className='flex flex-col justify-center w-screen items-center md:flex-row md:h-[60vh] overflow-hidden'>
            <div className='px-4 md:mx-[10%]'>
                <p className='font-bold text-2xl text-white my-10'>Imersão WhatsApp de Milhões</p>
                <p className='text-white mb-16 text-justify'>Eu quero que você trabalhe para ser rica e para isso, é importantíssimo aprender a vender com elegância. Nessa imersão, eu te ensino o meu método de vendas que me fez faturar mais de R$400 mil em 2022 apenas pelo whatsapp, mesmo tendo menos de 8 mil seguidores no instagram.
                    <br />
                    <br />
                ...
                <Link
                    ...
                    target="_blank"
                    className='flex rounded mb-10 my-2 p-2 bg-primary hover:brightness-125 text-black text-center items-center justify-center transition ease-in-out delay-150'>
