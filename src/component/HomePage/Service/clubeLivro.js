...
export default function ClubeLivro() {
    return (
        <div className='flex flex-col justify-around items-center w-screen px-[10%] md:px-[15%] py-6  min-h-[80vh] bg-primary-light bgNoise'>
            ...
            <div className='flex flex-col md:flex-row items-center justify-around'>
                ...
                <Image src={ImgAbout} width={700} alt='Mulher Sobreasda' className='my-2 md:w-1/4' />
                <div className='flex flex-col w-full space-y-2 md:w-1/3 text-left '>
